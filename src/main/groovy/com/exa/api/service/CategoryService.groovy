...
public class CategoryService{
    ...
    public Category updateCategory(Category category, Integer id) {
        ...
        if(updateCategory != null) {
            updateCategory.setKd_Sepatu(category.getKd_Sepatu());
            updateCategory.setNama_Sepatu(category.getNama_Sepatu());
            updateCategory.setJenis_Sepatu(category.getJenis_Sepatu());
        }
